...
```
104到107年度大學畢業者薪資提高比例超過5%的職業總共有22個,包含2個製造業,2個用水供應及污染整治業，1個批發及零售業,4個運輸及倉儲業,3個住宿及餐飲業,4個金融及保險業,4個不動產業,1個支援服務業,1個	其他服務業。
### 主要的職業種別是哪些種類呢?
```{r mainType}
#這是R Code Chunk
...
```{r male}
#這是R Code Chunk
#將104,107年大學-女/男的資料存到wage_table_gender
...
head(manwage_107[order(manwage_107$`大學-女/男.y`,decreasing = T),],10)
```
### 哪些行業女生薪資比男生薪資多? 
```{r female}
#這是R Code Chunk
